...
class ApproveChargeUpSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        buyer = Users.objects.select_for_update().get(id=validated_data['buyer'])
        ...
        phone_number = PhoneNumber.objects.select_for_update().get(phone_number=validated_data['phone_number'])
